...
export const splitPageContent: Record<LanguageCode, Record<SplitPageKey, SplitPageContent>> = {
  ja: {
    "v-about": {
      ...
      sections: [
        {
          heading: "企業概要",
          body: "会社名：HT Global Co., Ltd.（株式会社HTグローバル） / 宅建免許：東京都知事（１）第114049号 / 東京本社：〒132-0035 東京都江戸川区平井5-38-3 サンヴェールボニー301号 / TEL/FAX：03-6657-2050 / FAX：03-6657-2059 / Mobile：070-9098-4825 / Email：ht.global.info1@gmail.com",
    ...
    "v-service": {
      ...
      paragraphs: [
        ...
        "[不動産仲介] コンドミニアム・マンション・新築一户建て・土地を含む幅広い物件カテゴリに対応。購入・売却・賃貸の全ての局面でサポートします。",
        "[賃貸管理・運用支援] 入居者募集・家賃管理・全国の漏水・修繕対応・確定申告サポートに至るまで、穏やかな運用を代行します。",
        "[リフォーム・リノベーション] 内装工事・設備交換・リモデルなど、信頼できる工務店ネットワークを活用して物件の価値を高めます。",
        "[定住・移住支援] 日本への入国手続きのサポートから、住む場所・学校・生活環境の情報提供まで、居住の立ち上げを復層支援します。",
        "[法人設立・ビザサポート] 日本での会社設立・法人登記手続きや、投資ビザ申請に伴う書類準備などをサポートします。",
      ],
      sections: [
        {
    ...
    blog: {
      ...
      paragraphs: [
        ...
        "投資を初めて検討する方から、すでに複数物件を所有する方まで、実務に役立つ情報を分かりやすくお届けします。",
      ],
    },
    contact: {
      title: "お問い合わせ",
      paragraphs: [
        "物件に関するご相談、投資プランのお説明、パートナーシップに関するオンラインなど、お気軽にお問い合わせください。",
        "内容をご確認の上、指定の連絡先までご連絡ください。通常、ビジネス日3日以内に返信いたします。",
      ],
    },
    cdmmr: {
      title: "特定商取引法に基づく表記",
  ...
  en: {
      ...
      sections: [
        {
          ...
          body: "HT Global Co., Ltd. (株式会社HTグローバル) / Real Estate License: Tokyo Governor (1) No. 114049 / Head Office: 〒132-0035 東京都江戸川区平井5-38-3 サンヴェールボニー301号 / TEL/FAX: 03-6657-2050 / FAX: 03-6657-2059 / Mobile: 070-9098-4825 / Email: ht.global.info1@gmail.com",
          image: "/assets/red/pexels-vanessa-garcia-6325982-scaled.jpg",
          reverse: false,
        },
        {
    ...
    "v-service": {
      title: "Our Services",
      paragraphs: [
        "HT Global provides a comprehensive suite of services for Japanese real estate investment.",
  ...
  zh: {
    "v-about": {
      ...
      paragraphs: [
        ...
        "我们的团队由精通日语、英语、中文和泰语的多语言专业人士组成，确保不同背景的客户都能得到文化适应的专业服务。",
      ...
      sections: [
        {
          heading: "企业概况",
          body: "公司名称：株式会社HTグローバル（HT Global Co., Ltd.）/ 宅建许可证：东京都知事（１）第114049号 / 总部：〒132-0035 东京都江户川区平井5-38-3 サンヴェールボニー301号 / 电话/传真：03-6657-2050 / 传真：03-6657-2059 / 手机：070-9098-4825 / Email：ht.global.info1@gmail.com",
          image: "/assets/red/pexels-vanessa-garcia-6325982-scaled.jpg",
          reverse: false,
        },
        {
    ...
    blog: {
      title: "博客",
      paragraphs: [
        "HT Global 博客定期分享日本不动产市场动态、政策变化、税务信息以及精选物业信息。",
  ...
  vi: {
      ...
      sections: [
        {
          ...
          body: "Tên công ty: HT Global Co., Ltd. (株式会社HTグローバル) / Giấy phép BĐS: Tokyo Governor (1) No. 114049 / Trụ sở chính: 〒132-0035 東京都江戸川区平井5-38-3 サンヴェールボニー301号 / ĐT/Fax: 03-6657-2050 / Fax: 03-6657-2059 / Mobile: 070-9098-4825 / Email: ht.global.info1@gmail.com",
          image: "/assets/red/pexels-vanessa-garcia-6325982-scaled.jpg",
          reverse: false,
        },
        {
    ...
    "v-service": {
      ...
      paragraphs: [
        ...
        "[Môi giới bất động sản] Căn hộ, chung cư, nhà ở và đất nền — bao gồm mua, bán và cho thuê.",
        "[Dịch vụ quản lý cho thuê] Tìm khách thuê, quản lý hợp đồng, sửa chữa và quyết toán thuế.",
        "[Dịch vụ cải tạo] Kết nối với các đơn vị thi công uy tín để tăng giá trị bất động sản.",
        "[Dịch vụ chuyển nhượng] Hỗ trợ khách hàng nước ngoài đăng ký và định cư tại Nhật Bản.",
